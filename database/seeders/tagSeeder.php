    ...
    public function run()
    {
        $arr = [
            ...
            [
                ...
                'config'=>['color'=>'greey','icon'=>'fa fa-times','t_p'=>'estudante','genero'=>['m']]
            ],
            [
            ...
            [
                ...
                'config'=>['color'=>'warning','icon'=>'fa fa-times','t_p'=>'estudante','genero'=>['m','f']]
            ],
            [
            ...
            [
                ...
                'ordem'=>10,
                'obs'=>'',
                'config'=>['color'=>'warning','icon'=>'fa fa-times','t_p'=>'estudante','genero'=>['m','f'],'local'=>'ministerio']
            ],
            [
            ...
            [
                ...
                'config'=>['color'=>'warning','icon'=>'fa fa-times','t_p'=>'estudante','genero'=>['m']]
            ],
            [
                'nome'=>'Vida 1',
                'pai'=>1,
            ...
            [
                ...
                'ordem'=>16,
                'obs'=>'',
                'config'=>['color'=>'warning','icon'=>'fa fa-times','t_p'=>'mecanica']
            ],
            [
                'nome'=>'Oração final',
                'pai'=>1,
